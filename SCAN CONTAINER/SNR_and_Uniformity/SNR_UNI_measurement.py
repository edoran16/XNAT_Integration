...
def main(argv):
    ...
    sd, pn = sf.dicom_geo(fulldicomfile)
    ...
    print('_____.___PERFORMING ANALYSIS OF SNR___._____')
    sf.snr_analysis(fulldicomfile, imdata, img, outputpath, caseT, caseS, caseC)

    print('_____.___PERFORMING ANALYSIS OF UNIFORMITY___._____')
    uf.uniformity_analysis(fulldicomfile, imdata, img, outputpath, caseT, caseS, caseC)
